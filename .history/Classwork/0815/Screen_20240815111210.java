...
public class Screen extends JPanel implements ActionListener {
    ...
    public void eval(int num, String action)
    {
        if (action == "+")
        {
            cur_num += num;
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource() == plus){
            if(ans.getText() != ""){
                eval(Double.toString(ans.getText()), cur_action);
                cur_action = "+";
                ans.setText("");
            }
            ...
            if(ans.getText() != ""){
                eval(Integer.parseInt(ans.getText()), cur_action);
                ans.setText(Double.(cur_num));
            }
        }
    }
