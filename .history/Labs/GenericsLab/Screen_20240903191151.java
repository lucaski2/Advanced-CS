...
public class Screen extends JPanel implements ActionListener
{
    ...
    private JTextField period_field = new JTextField();
    ...
    public Screen()
    {
        ...
        this.add(name_field);
        period_field.setBounds(250, 100, 150, 25);
        this.add(period_field);
        name_field.setVisible(false);
        period_field.setVisible(false);
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        else if (e.getSource() == addPerson)
        {
            ...
            int period = Integer.parseInt(period_field.getText());
            students.add(new Student(name));
            students.get(students.size() - 1).addClass(period, "Class");
