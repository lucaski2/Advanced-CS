...
public class Screen extends JPanel implements ActionListener
{
    ...
    private JButton submit_new_class = new JButton("Submit");
    ...
    public Screen()
    {
        ...
        new_class.setBounds(250, 100, 150, 25);
        this.add(new_class);
        new_class.setVisible(false);
        new_period.setBounds(250, 150, 150, 25);
        this.add(new_period);
        new_period.setVisible(false);
        submit_new_class.setBounds(250, 200, 150, 25);
