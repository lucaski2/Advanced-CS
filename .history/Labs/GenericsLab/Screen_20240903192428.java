...
public class Screen extends JPanel implements ActionListener
{
    ...
    public Screen()
    {
        ...
        new_class.setBounds(450, 50, 150, 25);
        this.add(new_class);
        ...
        submit_new_class.addActionListener(this);
    ...
    public void paintComponent(Graphics g)
    {
        ...
        else if (adding_student)
        {
            ...
            g.drawString("Enter the name of the student", 250, 30);
        }
        else
        {
            g.setFont(new Font("Arial", Font.BOLD, 20));
            ...
            g.drawString("Enter class name", 475, 30);
            g.drawString("Enter period", 475, 130);
        }
        repaint();
    }
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        else if (e.getSource() == submit_new_class)
        {
            String className = new_class.getText();
            int period = Integer.parseInt(new_period.getText());
            students.get(cur_index_showing).addClass(period, className);
            new_class.setText("");
            new_period.setText("");
