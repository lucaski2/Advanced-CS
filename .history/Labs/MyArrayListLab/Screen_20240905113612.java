...
public class Screen extends JPanel implements ActionListener
{
    ...
    public Screen()
    {
        ...
        addSong.setBounds(250, 300, 150, 25);
    ...
    public void paintComponent(Graphics g)
    {
        ...
        for (int i = 0; i < songs.size(); i++)
        {
            g.drawString("Song: " + songs.get(i).getName(), 300, 50 + 50 * i);
            g.drawString("Artist: " + songs.get(i).getArtist(), 300, 75 + 50 * i);
            g.drawString("Album: " + songs.get(i).getAlbum(), 300, 100 + 50 * i);
        }
