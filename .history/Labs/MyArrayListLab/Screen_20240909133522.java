...
public class Screen extends JPanel implements ActionListener
{
    ...
    private JTextField index = new JTextField("Location");
    ...
    public Screen()
    {
        ...
        index.setBounds(475, 550, 125, 25);
        this.add(index);

        name.setBounds(25, 550, 125, 25);
        this.add(name);

        artist.setBounds(175, 550, 125, 25);
        this.add(artist);

        album.setBounds(325, 550, 125, 25);
        this.add(album);

        addSong.setBounds(625, 550, 100, 25);
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        {
            songs.add(new Song(name.getText(), artist.getText(), album.getText()), Integer.parseInt(index.getText()) - 1);
            JButton button = new JButton("Delete");
        ...
        else
        {
            for (int i = 0; i < buttons.size(); i++)
            {
                if (e.getSource() == buttons.get(i))
                {
                    ...
                    {
                        buttons.get(j).setBounds(50, 50 + 50 * j, 200, 25);
                    }
                    break;
                }
            }
